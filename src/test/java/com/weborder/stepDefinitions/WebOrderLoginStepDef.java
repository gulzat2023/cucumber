...
public class WebOrderLoginStepDef {
    ...
    public void user_validates_the_error_message(String expectedErrorMessage) {Assert.assertEquals(expectedErrorMessage,
            webOrderLoginPage.validateErrorMessage());
    }
