...
webOrderFoodOrderPage.chooseAndValidateLocation(deliveryOption, address);
    ...
    public void user_clicks_the_create_group_order_button() throws InterruptedException {webOrderFoodOrderPage.clickCreateGroupOrderButton();
    }
    ...
    @Then("User validates the word message from description")
    public void user_validates_the_word_message_from_description(String text) {
