...
smartBearOrderPage.sendProductInformation(product, quantity);
    ...
    @Then("User click process button and validate {string}")
    public void user_click_process_button_and_validate(String expectedMessage) {
    ...
    public void user_validates_all_information_from_table(String name, String product, String quantity, String street, String city, String state,
    ...
    public void user_provides_name_street_city_state_zip_for_address_information(DataTable dataTable) {
        ...
        smartBearOrderPage.sendAddressInformation(addressInformation.get("name"),addressInformation.get("street"),addressInformation.get("city"),
                addressInformation.get("state"),addressInformation.get("zip"));
    }
    ...
    public void user_provides_card_type_card_number_expiration_date_for_payment_information(DataTable dataTable) {
        ...
        smartBearOrderPage.sendPaymentInformation(paymentInformation.get("cardType"),paymentInformation.get("cardNumber"),
                            paymentInformation.get("expirationDate"));

    }
    @Then("User click process button and validate message")
    public void user_click_process_button_and_validate_message(DataTable dataTable) {
